...
class EmailAnalyzerGUI:
    ...
    def setup_styles(self):
        ...
        # Style cho Frame và các widget khác
        self.style.configure(
    ...
    def setup_gui(self):
        ...
        self.content_text_menu.add_command(
            label="Select All", command=self.select_all_text)
    ...
    def format_html_content(self, content):
        """Format nội dung HTML thành văn bản có định dạng"""
        try:
